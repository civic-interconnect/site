...
- Schema URIs are found from the file names `schemas/core/cep.entity.schema.json`, etc. 
- Schemas are unversioned at the path, and the `schemaVersion` field provides the version.
